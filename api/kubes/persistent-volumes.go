...
func (u KubeRequest) CreateVolumesPod(Pod VolumesPod) (*corev1.Pod, error) {
			...
			Containers: []corev1.Container{
				{
					...
					VolumeMounts: []corev1.VolumeMount{
						{
							Name:      Pod.VolumeName,
							MountPath: Pod.MountPath, //"/usr/share/mongo"
						},
					},
				},
			},
	...
	pod, err := u.clientset.CoreV1().Pods(Pod.Namespace).Create(context.TODO(), newpod, metav1.CreateOptions{})
